    ...
    <div class="container" style="max-width: 850px;">
        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
            <div>
                ...
                <p class="text-muted small m-0 mt-1">Aggiungi un nuovo tag mood.</p>
            </div>
            ...
            <div class="card-body p-4 p-md-5 bg-white">
                ...
                <form action="{{ route('admin.moods.store') }}" method="POST">
                    ...
                    <div class="mb-5">
                        ...
                        <input type="text" name="name" id="name" class="form-control border-2" placeholder="Es. curioso" required style="border-radius: 8px; height: 45px;">
                    </div>
                    ...
                    <div class="d-flex justify-content-end">
                        <button type="submit" class="btn text-white fw-bold text-uppercase px-5 py-3 shadow-sm border-0" 
                            ...
                            <i class="bi bi-cloud-check me-2"></i> Salva Mood
                        </button>
                    </div>
